...
const ViewCart = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => (
        <div className="view__count">
          <Button icon={<MinusCircleOutlined />} onClick={decline} />
          <div className="view__count--count">{count}</div>
          <Button icon={<PlusCircleOutlined />} onClick={increase} />
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      render: () => (
        <>
          <Button className="product__hover" icon={<EditOutlined />} />
          <Button className="product__hover" icon={<DeleteOutlined />} />
        </>
      )
    }
  ]
  ...
  return (
    <div className="vier__cart__main">
      <Table columns={columns} dataSource={data} pagination={false} className="view__table ant-table-bordered" />
            ...
            <div className="main_more__right--extra ">
              ...
              <div className="main_more--icon">
                ...
                <div className="main_more--dowup">
                  <div>
                    <FontAwesomeIcon icon={faCaretUp} onClick={increase} />
                  </div>
                  <div>
                    <FontAwesomeIcon icon={faCaretDown} onClick={decline} />
                  </div>
                </div>
              </div>
            </div>
