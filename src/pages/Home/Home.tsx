...
const Home = () => {
  ...
  const popularItem = [
    {
      img: 'https://cdn.shopify.com/s/files/1/1280/1207/products/21_35dd1a38-feba-48e5-b8ac-42fa0ca3aaf0_large.jpg?v=1640260970',
      title: 'Example',
      description: '80$'
    },
    {
      img: 'https://cdn.shopify.com/s/files/1/1280/1207/products/20_168a47b2-4fe8-4b1e-8d2a-6732c8ada61a_large.jpg?v=1640260944',
      title: 'Example',
      description: '80$'
    },
    {
      img: 'https://cdn.shopify.com/s/files/1/1280/1207/products/19_9987f440-4e86-419f-973b-4c191d33f51b_large.jpg?v=1640260909',
      title: 'Example',
      description: '80$'
    },
    {
      img: 'https://cdn.shopify.com/s/files/1/1280/1207/products/5_e48a4865-c05c-4568-ba1b-37e6828ddfea_large.jpg?v=1640259829',
      title: 'Example',
      description: '80$'
    }
  ]
    ...
    <div>
        ...
        <div className="home__feature2">
          <div className="home__feature2__content">
            ...
            <div className="feature__item">
              <Row>
                <Col span={3}>
                  <img src="https://cdn.shopify.com/s/files/1/1280/1207/files/battery-charge.png?v=1639385813" alt="" />
                </Col>
                <Col span={9}>
                  <h3>30 Mins</h3>
                  <p>Flight time</p>
      ...
      <div className="home__popular2">
        ...
        <div className="home__popular2__main">
          {/* <div className="home__popular2__main__item">
            <Card
              hoverable
              style={{ width: 240 }}
              cover={
                <img
                  alt="example"
                  src="https://cdn.shopify.com/s/files/1/1280/1207/products/21_35dd1a38-feba-48e5-b8ac-42fa0ca3aaf0_large.jpg?v=1640260970"
                />
              }
            >
              <Meta title="Example" description="80$" />
            </Card>
          </div> */}
          {popularItem.map((item, index) => (
            <div className="home__popular2__main__item" key={index}>
              <Card hoverable style={{ width: 240 }} cover={<img alt="example" src={item.img} />}>
